...
/* package test-haskell-0.1.0.0 */
#define VERSION_test_haskell "0.1.0.0"
#define MIN_VERSION_test_haskell(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "test-haskell-0.1.0.0"

#define CURRENT_PACKAGE_KEY "test-haskell-0.1.0.0"
